...
vim.keymap.set('n', '<Leader>gc', Snacks.picker.git_log, { desc = 'Find commit' })
vim.keymap.set('n', '<Leader>gp', ':Git push<CR>', { desc = 'Git push' })
vim.keymap.set('n', '<Leader>gl', ':Git pull<CR>', { desc = 'Git pull' })
vim.keymap.set('n', '<Leader>gL', ':Git pull --rebase --autostash<CR>', { desc = 'Git pull --rebase --autostash' })
vim.keymap.set('n', '<Leader>gb', Snacks.picker.git_branches, { desc = 'Find branch' })
vim.keymap.set('n', '<Leader>gs', Snacks.picker.git_stash, { desc = 'Find stash' })
