...
vim.keymap.set('n', 'gT', ':Telescope lsp_dynamic_workspace_symbols<CR>', { desc = 'Workspace symbols' })
vim.keymap.set('n', 'gX', ':Telescope diagnostics<CR>', { desc = 'Diagnostics' })
...
vim.keymap.set('n', '<Leader>cT', ':Telescope lsp_dynamic_workspace_symbols<CR>', { desc = 'Workspace symbols' })
vim.keymap.set('n', '<Leader>cX', ':Telescope diagnostics<CR>', { desc = 'Diagnostics' })
